...
public class AIGuard extends EntityAIBase
{
    World worldObj;
    ...
    public AIGuard(EntityCreature p_i1635_1_, Class tar, double p_i1635_3_, boolean p_i1635_5_, EntityPlayer owner)
    {
        this(p_i1635_1_, p_i1635_3_, p_i1635_5_);
        if(!tar.isInstance(owner)){
        	if(tar != EntityAgeable.class){
                this.classTarget = tar;
    ...
    public AIGuard(EntityCreature p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_)
    {
