...
public class GUIMachineInventory extends GuiContainer {

	private ResourceLocation slotGui = new ResourceLocation(MysteryMain.MODID+":textures/gui/GUItecSlot.png");
    private TileBaseInventoryMachine tile;   
	public GUIMachineInventory (InventoryPlayer inventoryPlayer,
			TileBaseInventoryMachine tileEntity) {
                super(new ContainerMachineBase(inventoryPlayer, tileEntity));
                tile = tileEntity;
        }
